...
export class Calendar extends React.Component {
  ...
  renderHeader() {
    ...
    if (this.props.dev) { // only add arrows in dev mode
      ...
      elements.unshift(
        <div className="col col-start non-print no-drag" key="header-left">
          <div className="icon" onClick={this.switchToPreviousMonth}>chevron_left</div>
        </div>
      );

      elements.push(
        <div className="col col-end non-print no-drag" onClick={this.switchToNextMonth} key={`header-right`}>
